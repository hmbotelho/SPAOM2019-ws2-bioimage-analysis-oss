...
### <a name="defaultoutputfolder">3.13. Selecting where to save data to</a>
The `Default output folder` is the most common convenient way to save most analysis results.
